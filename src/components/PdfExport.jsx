      ...
      <Page key="daily" style={styles.page}>
        ...
        <View style={styles.footerContainer}>
          ...
          <Text style={styles.footerText}>
            ...
            frutta a guscio, sedano, sesamo, soia, pesce, crostacei, solfiti, senape
          </Text>
          <Text style={styles.footerText}>
            EN: May contain the following allergens: gluten, eggs, peanuts, milk,
            nuts, celery, sesame, soy, fish, crustaceans, sulfites, mustard
          </Text>
        </View>
      </Page>
            ...
            <View style={styles.contentContainer}>
              ...
              {cat === 'Desserts' && (
                <Text style={styles.coverCharge}>
                  Gedeck und Brot € 2,00- pro Person — Coperto e pane € 2,00 a persona — Cover charge and bread € 2.00 per person
                </Text>
              )}
            </View>
